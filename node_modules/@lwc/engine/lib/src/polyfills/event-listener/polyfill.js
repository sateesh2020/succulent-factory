...
const node_2 = require("../../faux-shadow/node");
...
function doesEventNeedsPatch(e) {
    ...
    if (originalTarget instanceof Node) {
        if ((node_1.compareDocumentPosition.call(document, originalTarget) & node_1.DOCUMENT_POSITION_CONTAINED_BY) !== 0 && node_2.getNodeOwnerKey(originalTarget)) {
            return true;
        }
    }
    return false;
...
addEventListener.__lwcOriginal__ = element_1.addEventListener;
removeEventListener.__lwcOriginal__ = element_1.removeEventListener;
windowAddEventListener.__lwcOriginal__ = window_1.windowAddEventListener;
windowRemoveEventListener.__lwcOriginal__ = window_1.windowRemoveEventListener;
