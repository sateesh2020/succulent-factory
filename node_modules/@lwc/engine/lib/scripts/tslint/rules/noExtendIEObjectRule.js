...
Rule.metadata = {
    ...
    descriptionDetails: 'In IE11, some global constructors are type `object`, and this causes the code generated by @babel/plugin-transform-classes to throw.',
    rationale: tslint_1.Utils.dedent `
...
exports.Rule = Rule;
class NoExtendIEObject extends tslint_1.RuleWalker {
        ...
        if (/^extends/.test(text)) {
            if (node.types) {
                ...
                if (ILLEGAL_IDENTIFIER_SET.has(id)) {
                    this.addFailureAtNode(node, `Directly extending the "${id}" global constructor causes an error to be thrown in IE11. Use prototypal inheritance instead. :sadtrombone:`);
                }
            }
        }
    }
}
//# sourceMappingURL=noExtendIEObjectRule.js.map